...
export default function HowItWorks() {
  const goToDocs = () => {
    window.open(
      "https://1inch-agent-kit.gitbook.io/1inch-agent-kit-docs/",
      "_blank"
    );
  };
        ...
        <div className="flex items-start justify-between gap-8 mb-8">
          ...
          <div className="flex-1 text-left relative">
            <h2 className="text-4xl font-normal text-gray-900 mb-4">
              ...
              <span className="font-bold italic">1inch</span> Agent Kit into
              your project
            </h2>

            <p className="text-gray-600 mb-28">
              Select from our comprehensive suite of APIs including Portfolio
              tracking, Gas prices, Swap execution, and more. Each API can be
              configured to match your specific needs and trading strategy.
            </p>
