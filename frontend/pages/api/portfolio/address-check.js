// API route for address compliance check
export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `https://api.1inch.dev/portfolio/portfolio/v5.0/general/address_check?${queryParams.toString()}`;
    ...
    console.error('Address check API error:', error);
