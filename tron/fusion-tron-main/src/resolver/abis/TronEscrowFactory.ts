export const TronEscrowFactoryABI = [
  // Events - Same structure as Ethereum for compatibility
  {
    anonymous: false,
    inputs: [
      {
  ...
  // Tron-specific functions for energy/bandwidth optimization
  {
    inputs: [],
    name: "estimateEnergyUsage",
    outputs: [{ internalType: "uint256", name: "energy", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [],
    name: "estimateBandwidthUsage",
    outputs: [{ internalType: "uint256", name: "bandwidth", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
] as const;
