...
export declare namespace TronFusionExtension {
  export type TronSwapDataStruct = {
  ...
  export type TronSwapDataStructOutput = [
    tronRecipient: string,
    tronFactory: string,
...
export interface TronFusionExtensionInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "TRX_REPRESENTATION",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "deactivateSwap",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "getExpectedTrxAmount",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "getSrcEscrowAddress",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "getTronRecipient",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "getTronSwapData",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "hasActiveTronSwap",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "orderSwapData",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "orderToSrcEscrow",
    values: [BytesLike]
  ): string;
...
export namespace EthEscrowCreatedEvent {
...
export namespace TronEscrowRequestedEvent {
  export type InputTuple = [
    orderHash: BytesLike,
    tronFactory: string,
    secretHash: BytesLike,
...
export namespace TronSwapInitiatedEvent {
  export type InputTuple = [
    orderHash: BytesLike,
    maker: AddressLike,
    taker: AddressLike,
...
export interface TronFusionExtension extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "TRX_REPRESENTATION"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "deactivateSwap"
  ): TypedContractMethod<[orderHash: BytesLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "getExpectedTrxAmount"
  ): TypedContractMethod<[orderHash: BytesLike], [bigint], "view">;
  getFunction(
    nameOrSignature: "getSrcEscrowAddress"
  ): TypedContractMethod<[orderHash: BytesLike], [string], "view">;
  getFunction(
    nameOrSignature: "getTronRecipient"
  ): TypedContractMethod<[orderHash: BytesLike], [string], "view">;
  getFunction(
    nameOrSignature: "getTronSwapData"
  ): TypedContractMethod<
    [orderHash: BytesLike],
    [TronFusionExtension.TronSwapDataStructOutput],
    "view"
  >;
  getFunction(
    nameOrSignature: "hasActiveTronSwap"
  ): TypedContractMethod<[orderHash: BytesLike], [boolean], "view">;
  getFunction(
    nameOrSignature: "orderSwapData"
  ): TypedContractMethod<
    [arg0: BytesLike],
    [
      [string, string, bigint, string, bigint, bigint, boolean] & {
  ...
  >;
  getFunction(
    nameOrSignature: "orderToSrcEscrow"
  ...
  getEvent(
    key: "EthEscrowCreated"
  ): TypedContractEvent<
    EthEscrowCreatedEvent.InputTuple,
    EthEscrowCreatedEvent.OutputTuple,
    EthEscrowCreatedEvent.OutputObject
  >;
  getEvent(
  ...
  >;
  getEvent(
    key: "TronEscrowRequested"
  ): TypedContractEvent<
    TronEscrowRequestedEvent.InputTuple,
    TronEscrowRequestedEvent.OutputTuple,
    TronEscrowRequestedEvent.OutputObject
  >;
  getEvent(
    key: "TronSwapInitiated"
  ): TypedContractEvent<
    TronSwapInitiatedEvent.InputTuple,
    TronSwapInitiatedEvent.OutputTuple,
    TronSwapInitiatedEvent.OutputObject
  >;

  filters: {
    "EthEscrowCreated(bytes32,address,bytes32,uint256,uint256)": TypedContractEvent<
      EthEscrowCreatedEvent.InputTuple,
      EthEscrowCreatedEvent.OutputTuple,
      EthEscrowCreatedEvent.OutputObject
    >;
    EthEscrowCreated: TypedContractEvent<
      EthEscrowCreatedEvent.InputTuple,
      EthEscrowCreatedEvent.OutputTuple,
      EthEscrowCreatedEvent.OutputObject
    >;
    ...
    "TronEscrowRequested(bytes32,string,bytes32,uint256)": TypedContractEvent<
      TronEscrowRequestedEvent.InputTuple,
      TronEscrowRequestedEvent.OutputTuple,
      TronEscrowRequestedEvent.OutputObject
    >;
    TronEscrowRequested: TypedContractEvent<
      TronEscrowRequestedEvent.InputTuple,
      TronEscrowRequestedEvent.OutputTuple,
      TronEscrowRequestedEvent.OutputObject
    >;

    "TronSwapInitiated(bytes32,address,address,uint256,uint256,bytes32,string,address)": TypedContractEvent<
      TronSwapInitiatedEvent.InputTuple,
      TronSwapInitiatedEvent.OutputTuple,
      TronSwapInitiatedEvent.OutputObject
    >;
    TronSwapInitiated: TypedContractEvent<
      TronSwapInitiatedEvent.InputTuple,
      TronSwapInitiatedEvent.OutputTuple,
      TronSwapInitiatedEvent.OutputObject
    >;
