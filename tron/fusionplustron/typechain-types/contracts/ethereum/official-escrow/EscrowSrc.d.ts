...
export interface EscrowSrcInterface extends Interface {
...
export interface EscrowSrc extends BaseContract {
    connect(runner?: ContractRunner | null): EscrowSrc;
...
//# sourceMappingURL=EscrowSrc.d.ts.map