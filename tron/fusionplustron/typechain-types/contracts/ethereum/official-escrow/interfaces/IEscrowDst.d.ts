...
export interface IEscrowDstInterface extends Interface {
...
export interface IEscrowDst extends BaseContract {
    connect(runner?: ContractRunner | null): IEscrowDst;
    waitForDeployment(): Promise<this>;
    interface: IEscrowDstInterface;
...
//# sourceMappingURL=IEscrowDst.d.ts.map