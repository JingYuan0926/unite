...
export interface ResolverExampleInterface extends Interface {
    getFunction(nameOrSignature: "arbitraryCalls" | "deployDst" | "deploySrc" | "owner" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
...
export interface ResolverExample extends BaseContract {
    connect(runner?: ContractRunner | null): ResolverExample;
    waitForDeployment(): Promise<this>;
    interface: ResolverExampleInterface;
...
//# sourceMappingURL=ResolverExample.d.ts.map