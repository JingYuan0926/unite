...
export interface EscrowDstZkSyncInterface extends Interface {
    getFunction(nameOrSignature: "FACTORY" | "PROXY_BYTECODE_HASH" | "RESCUE_DELAY" | "cancel" | "publicWithdraw" | "rescueFunds" | "withdraw"): FunctionFragment;
...
export interface EscrowDstZkSync extends BaseContract {
    connect(runner?: ContractRunner | null): EscrowDstZkSync;
    waitForDeployment(): Promise<this>;
    interface: EscrowDstZkSyncInterface;
...
//# sourceMappingURL=EscrowDstZkSync.d.ts.map