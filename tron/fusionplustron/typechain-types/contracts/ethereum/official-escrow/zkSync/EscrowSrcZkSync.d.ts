...
export interface EscrowSrcZkSyncInterface extends Interface {
    getFunction(nameOrSignature: "FACTORY" | "PROXY_BYTECODE_HASH" | "RESCUE_DELAY" | "cancel" | "publicCancel" | "publicWithdraw" | "rescueFunds" | "withdraw" | "withdrawTo"): FunctionFragment;
...
export interface EscrowSrcZkSync extends BaseContract {
    connect(runner?: ContractRunner | null): EscrowSrcZkSync;
    waitForDeployment(): Promise<this>;
    interface: EscrowSrcZkSyncInterface;
...
//# sourceMappingURL=EscrowSrcZkSync.d.ts.map