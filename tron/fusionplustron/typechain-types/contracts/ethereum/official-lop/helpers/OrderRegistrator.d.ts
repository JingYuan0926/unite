...
export interface OrderRegistratorInterface extends Interface {
...
export interface OrderRegistrator extends BaseContract {
    connect(runner?: ContractRunner | null): OrderRegistrator;
    waitForDeployment(): Promise<this>;
    interface: OrderRegistratorInterface;
...
//# sourceMappingURL=OrderRegistrator.d.ts.map