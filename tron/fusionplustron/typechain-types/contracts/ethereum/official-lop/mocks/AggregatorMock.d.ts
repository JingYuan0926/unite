...
export interface AggregatorMockInterface extends Interface {
    getFunction(nameOrSignature: "decimals" | "description" | "getAnswer" | "getRoundData" | "getTimestamp" | "latestAnswer" | "latestRound" | "latestRoundData" | "latestTimestamp" | "version"): FunctionFragment;
...
export interface AggregatorMock extends BaseContract {
    connect(runner?: ContractRunner | null): AggregatorMock;
    ...
    getFunction(nameOrSignature: "getAnswer"): TypedContractMethod<[roundId: BigNumberish], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "getTimestamp"): TypedContractMethod<[roundId: BigNumberish], [bigint], "view">;
...
//# sourceMappingURL=AggregatorMock.d.ts.map