...
export interface MakerContractInterface extends Interface {
    getFunction(nameOrSignature: "FEE" | "FEE2" | "PROTOCOL" | "TOKEN0" | "TOKEN1" | "allowance" | "approve" | "balanceOf" | "decimals" | "deposit" | "depositFor" | "isValidSignature" | "name" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "withdraw" | "withdrawFor"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Approval" | "Transfer"): EventFragment;
    encodeFunctionData(functionFragment: "FEE", values?: undefined): string;
    encodeFunctionData(functionFragment: "FEE2", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "depositFor", values: [AddressLike, BigNumberish, AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "withdrawFor", values: [AddressLike, BigNumberish, AddressLike]): string;
    decodeFunctionResult(functionFragment: "FEE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "FEE2", data: BytesLike): Result;
...
export interface MakerContract extends BaseContract {
    connect(runner?: ContractRunner | null): MakerContract;
    ...
    FEE2: TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "FEE2"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "withdrawFor"): TypedContractMethod<[
        token: AddressLike,
        amount: BigNumberish,
        to: AddressLike
    ], [
...
//# sourceMappingURL=MakerContract.d.ts.map