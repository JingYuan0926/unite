...
export interface RecursiveMatcherInterface extends Interface {
    getFunction(nameOrSignature: "matchOrders" | "takerInteraction"): FunctionFragment;
    encodeFunctionData(functionFragment: "matchOrders", values: [
        AddressLike,
...
export interface RecursiveMatcher extends BaseContract {
    connect(runner?: ContractRunner | null): RecursiveMatcher;
    waitForDeployment(): Promise<this>;
    interface: RecursiveMatcherInterface;
...
//# sourceMappingURL=RecursiveMatcher.d.ts.map