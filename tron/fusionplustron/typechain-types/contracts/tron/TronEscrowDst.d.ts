...
export interface TronEscrowDstInterface extends Interface {
    getFunction(nameOrSignature: "FACTORY" | "PROXY_BYTECODE_HASH" | "RESCUE_DELAY" | "cancel" | "getTronAddress" | "isTronNetwork" | "publicWithdraw" | "rescueFunds" | "withdraw"): FunctionFragment;
...
export interface TronEscrowDst extends BaseContract {
    connect(runner?: ContractRunner | null): TronEscrowDst;
    waitForDeployment(): Promise<this>;
    interface: TronEscrowDstInterface;
...
//# sourceMappingURL=TronEscrowDst.d.ts.map