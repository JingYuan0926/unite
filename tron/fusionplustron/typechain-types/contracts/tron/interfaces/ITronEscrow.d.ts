...
export interface ITronEscrowInterface extends Interface {
    getFunction(nameOrSignature: "FACTORY" | "RESCUE_DELAY" | "cancel" | "getTronAddress" | "isTronNetwork" | "rescueFunds" | "withdraw"): FunctionFragment;
...
export interface ITronEscrow extends BaseContract {
    connect(runner?: ContractRunner | null): ITronEscrow;
    waitForDeployment(): Promise<this>;
    interface: ITronEscrowInterface;
...
//# sourceMappingURL=ITronEscrow.d.ts.map