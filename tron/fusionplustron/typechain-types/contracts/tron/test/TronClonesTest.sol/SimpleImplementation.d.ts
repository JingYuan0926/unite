...
export interface SimpleImplementationInterface extends Interface {
...
export interface SimpleImplementation extends BaseContract {
    connect(runner?: ContractRunner | null): SimpleImplementation;
    ...
    getFunction(nameOrSignature: "setValue"): TypedContractMethod<[_value: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "value"): TypedContractMethod<[], [bigint], "view">;
    filters: {};
}
//# sourceMappingURL=SimpleImplementation.d.ts.map