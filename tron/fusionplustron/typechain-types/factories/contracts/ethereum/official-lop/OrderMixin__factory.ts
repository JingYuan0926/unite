...
import type {
  OrderMixin,
  OrderMixinInterface,
} from "../../../../contracts/ethereum/official-lop/OrderMixin";
...
export class OrderMixin__factory {
  ...
  static createInterface(): OrderMixinInterface {
    return new Interface(_abi) as OrderMixinInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): OrderMixin {
    return new Contract(address, _abi, runner) as unknown as OrderMixin;
  }
}
